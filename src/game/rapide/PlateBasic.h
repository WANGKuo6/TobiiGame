#ifndef PLATEBASIC_INCLUDED
#define PLATEBASIC_INCLUDED
...
namespace core
{
	...
	namespace fx
	{
		...
		class PlateBasic : public GameObject
		{
		public:
			/// Construct a Button with all the needed attributes
			PlateBasic(Window* window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, SDL_Rect image_xywh, void* payload = nullptr);

			/// Construct a Button with all the needed attributes and set the visible attributes default value
			PlateBasic(Window* window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, SDL_Rect image_xywh, bool setVisible, void* payload = nullptr);

			/// Construct a Button with all the needed attributes and a selector representing if the button is clicked or not
			PlateBasic(Window* window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, std::string selector, SDL_Rect image_xywh, void* payload = nullptr);
			...
			PlateBasic(Window* window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, std::string selector, SDL_Rect image_xywh, bool setVisible, void* payload = nullptr);
