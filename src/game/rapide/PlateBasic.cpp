...
core::fx::PlateBasic::PlateBasic(Window * window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, SDL_Rect image_xywh, void* payload) :
	PlateBasic(window, musicManager, timeCounter, text, fontSize, color, image_source, "", image_xywh, true, payload)
{}

core::fx::PlateBasic::PlateBasic(Window * window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, SDL_Rect image_xywh, bool setVisible, void* payload) :
	PlateBasic(window, musicManager, timeCounter, text, fontSize, color, image_source, "", image_xywh, setVisible, payload)
{}

core::fx::PlateBasic::PlateBasic(Window* window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, std::string selector, SDL_Rect image_xywh, void* payload) :
	PlateBasic(window, musicManager, timeCounter, text, fontSize, color, image_source, selector, image_xywh, true, payload)
{}

core::fx::PlateBasic::PlateBasic(Window * window, MusicManager* musicManager, int timeCounter, std::string text, int fontSize, SDL_Color color, std::string image_source, std::string selector, SDL_Rect image_xywh, bool setVisible, void* payload) :
...
void core::fx::PlateBasic::update(coord cursorPosition)
{
	if (!isVisible)
		return;
...
void core::fx::PlateBasic::update(coord cursorPosition, SDL_Rect frame, ratio resizeRatio)
{
	if (!isVisible)
		return;
...
void core::fx::PlateBasic::gameButtonUpdate(coord cursorPosition, int size, int i)
{
...
bool core::fx::PlateBasic::isButtonPressed()
{
	if (!is_active_)
	{
		return false;
...
void* core::fx::PlateBasic::getPayload()
{
	return payload_;
}

void core::fx::PlateBasic::setActive(bool active)
{
	is_active_ = active;
}

void core::fx::PlateBasic::setSound(std::string path) {
